...
if (isGroup) {
  ...
  Fg.sendMessage(from, `Lo sentimos, el grupo debe  tener  ${memberlimit} miembros, Adi�s  invitame cuando  haya esa cantidad`, text)
...
//-- Leer autom�ticamente si hay un mensaje
