...
const menu = (tanggal, jam, pushname, sender, Lxa, prefix, user, uptime, isGroupAdmins, groupMetadata, groupAdmins, Welcome_, AntiLink_, Leveling_, role, AntiLinktele_, AntiLinkdis_, Nopor_, isGroup, process) => { 
  if (isGroupAdmins){
